...
ADDITIONAL_QUESTIONS = {
    ...
    "weekday-diary": [question("朝ご飯を食べたあとで、何をしますか。", ["学校へ行きます", "駅で切符を買います", "病院へ行きます", "寝ます"], 0, "sequence")],
    ...
    "pool-notice": [question("土曜日の朝にプールへ行く場合、何時から開いていますか。", ["午前九時から", "午後七時から", "午後一時から", "午前六時から"], 0, "condition detail")],
    "post-office-hours": [
    ...
    "shop-sale": [question("半額の商品を買いたい人は、何を選びますか。", ["靴", "本", "かばん", "帽子"], 0, "task-based response")],
