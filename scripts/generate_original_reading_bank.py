...
ADDITIONAL_QUESTIONS = {
    ...
    "weekday-diary": [question("朝ご飯を食べたあとで、何をしますか。", ["学校へ行きます", "図書館で本を読みます", "家で宿題をします", "寝ます"], 0, "sequence")],
    "morning-message": [question("「あとで」は、いつを指しますか。", ["朝ご飯を食べたあと", "昼ご飯を食べたあと", "学校へ行ったあと", "寝る前"], 0, "reference")],
    "friend-visit": [question("「一緒に」は、どういう意味ですか。", ["友達と二人で", "一人で", "先生と三人で", "家族と別々に"], 0, "reference")],
    "concert-plan": [question("「あとで」は、何のあとですか。", ["コンサートのあと", "朝ご飯のあと", "授業のあと", "仕事のあと"], 0, "reference")],
    "class-change": [question("明日の授業は午前に始まりますか。", ["はい、午前九時からです", "いいえ、午後二時からです", "はい、いつもの時間です", "いいえ、授業はありません"], 1, "simple inference")],
    "school-festival": [
        question("雨のとき、どこで映画を見ますか。", ["教室", "体育館", "駅", "家"], 0, "condition detail"),
        question("雨の日でも、お祭りに参加できそうですか。", ["はい、教室で映画を見られます", "いいえ、学校が閉まります", "はい、海へ行けます", "いいえ、駅へ行きます"], 0, "simple inference"),
    ],
    "weekend-plan": [question("日曜日に友達と会う予定がありそうですか。", ["はい、映画を見に行く予定です", "いいえ、病院で働く予定です", "はい、駅で切符を買う予定です", "いいえ、家を引っ越す予定です"], 0, "simple inference")],
    "pool-notice": [question("土曜日の朝にプールへ行く場合、何時から開いていますか。", ["午前九時から", "午前十時から", "午後一時から", "午後六時から"], 0, "condition detail")],
    "post-office-hours": [
        question("昼休みに郵便局へ行く場合、いつを避けますか。", ["十二時から一時", "午前九時から十時", "午後一時から二時", "午後四時から五時"], 0, "condition detail"),
        question("昼休みに郵便局へ行きたい人は、どうしますか。", ["十二時から一時を避けます", "土曜日に必ず行きます", "朝八時に行きます", "日曜日に電話します"], 0, "task-based response"),
    ],
    "house-key": [question("出かける人は、まずどうしますか。", ["鍵を取ります", "本を読みます", "電車に乗ります", "花を買います"], 0, "task-based response")],
    "shop-sale": [question("半額の商品を買いたい人は、何を選びますか。", ["靴", "シャツ", "かばん", "帽子"], 0, "task-based response")],
    "new-neighbor": [question("この話は何についてですか。", ["新しい家族への挨拶", "病院の予約", "学校の試験", "旅行の計画"], 0, "main idea")],
    "school-council": [question("今年の文化祭について、正しいものはどれですか。", ["みんなで劇をします", "映画を見ます", "写真を撮ります", "料理をします"], 0, "main idea")],
    "cooking-class": [question("先生が説明したあとで、学生は何をしますか。", ["野菜を切ります", "家へ帰ります", "映画を見ます", "電車に乗ります"], 0, "sequence")],
    "garden-work": [question("父が仕事を終えたあと、二人は何をしましたか。", ["昼ご飯を食べました", "買い物をしました", "映画を見ました", "駅へ行きました"], 0, "sequence")],
    "package-delivery": [
        question("荷物が届いたあと、私はまず何をしましたか。", ["配達員に電話しました", "店へ買い物に行きました", "駅で電車を待ちました", "友達に会いました"], 0, "sequence"),
        question("荷物が届いたとき家にいなかった人は、どうしますか。", ["配達員に電話します", "荷物を捨てます", "学校へ行きます", "来月まで待ちます"], 0, "task-based response"),
    ],
    "winter-clothes": [question("なぜ暖かい手袋を買いましたか。", ["今年の冬は寒くなりそうだからです", "写真を撮りたいからです", "電車に乗るからです", "友達が来るからです"], 0, "reason")],
    "weekend-visit": [question("どんなとき、自転車で行くつもりですか。", ["天気がよいとき", "雨が降るとき", "仕事があるとき", "夜遅くなるとき"], 0, "condition detail")],
    "weather-plan": [
        question("日曜日の午後に、外で活動してもよさそうですか。", ["いいえ、雨になるでしょう", "はい、晴れるでしょう", "はい、博物館が開くでしょう", "いいえ、土曜日が休みだからです"], 0, "simple inference"),
        question("日曜日の午後に外で活動すると、どうなりそうですか。", ["雨になりそうです", "晴れになりそうです", "店が閉まりそうです", "電車が速くなりそうです"], 0, "condition detail"),
    ],
    "school-trip": [question("校外学習に行く人は、何を用意しますか。", ["昼食と水を持ってきます", "映画の切符を買います", "駅で本を借ります", "夜にホテルを予約します"], 0, "task-based response")],
    "clinic-sheet": [question("水曜日の午後に受付へ行きたい人は、どうしますか。", ["別の時間に行きます", "日曜日に行きます", "午後三時に行きます", "受付で名前を書きます"], 0, "appropriate action")],
}
