...
VISUAL_SCENES = {
    "station": ("waiting-station", "A traveler is waiting at a station and speaking with staff."),
    "cafe": ("ordering-food", "A customer is ordering food from a café server."),
    "school": ("school-class", "A student is speaking with a teacher in class."),
    "home": ("leaving-home", "A family member is leaving home and checking what to take."),
    "shopping": ("paying-shop", "A customer is paying for an item at a shop."),
    "people": ("meeting-someone", "Two people are meeting and choosing what to say."),
    "health": ("asking-help", "A patient is asking clinic staff for help."),
    "transport": ("asking-directions", "A traveler is asking for directions near local transport."),
    "study": ("entering-room", "A learner is entering a quiet study room."),
    "food": ("ordering-food", "A customer is ordering food from restaurant staff."),
    "errands": ("passing-object", "A customer is receiving an item across a service counter."),
    "weather": ("returning-home", "Two people are deciding when to return home because of weather."),
    ...
    "administration": ("using-elevator", "A visitor is asking which way to go inside a public building."),
    "work": ("arriving-late", "A coworker is explaining a late arrival at work."),
    "community": ("offering-seat", "A visitor is offering a seat at a community event."),
    "hobby": ("dropping-something", "Two friends are reacting after someone drops an item."),
}
