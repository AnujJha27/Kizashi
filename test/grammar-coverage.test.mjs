...
test("checked-in grammar registry preserves the current evidence boundary", async () => {
  ...
  assert.deepEqual(registry.summary.N4, { rawPatterns: 148, canonicalConcepts: 29, complete: 0, partial: 25, missing: 4, unresolved: 111, levelDisagreements: 1 });
  ...
  assert.equal(registry.sources.find((source) => source.id === "irodori-sentence-patterns").references, 64);
});
