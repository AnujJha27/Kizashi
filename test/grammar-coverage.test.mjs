...
test("checked-in grammar registry preserves the current evidence boundary", async () => {
  ...
  assert.deepEqual(registry.summary.N4, { rawPatterns: 179, canonicalConcepts: 61, complete: 3, partial: 52, missing: 6, unresolved: 89, levelDisagreements: 7 });
  ...
  assert.equal(registry.sources.find((source) => source.id === "irodori-sentence-patterns").references, 105);
