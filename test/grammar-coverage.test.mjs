...
test("checked-in grammar registry preserves the current evidence boundary", async () => {
  ...
  assert.deepEqual(registry.summary.N4, { rawPatterns: 154, canonicalConcepts: 36, complete: 0, partial: 32, missing: 4, unresolved: 107, levelDisagreements: 1 });
  ...
  assert.equal(registry.sources.find((source) => source.id === "irodori-sentence-patterns").references, 71);
});
