...
test("checked-in grammar registry preserves the current evidence boundary", async () => {
  ...
  assert.deepEqual(registry.summary.N5, { rawPatterns: 224, canonicalConcepts: 46, complete: 17, partial: 23, missing: 6, unresolved: 99, levelDisagreements: 4 });
  assert.deepEqual(registry.summary.N4, { rawPatterns: 188, canonicalConcepts: 70, complete: 9, partial: 56, missing: 5, unresolved: 79, levelDisagreements: 10 });
  ...
  assert.equal(registry.sources.find((source) => source.id === "irodori-sentence-patterns").references, 124);
