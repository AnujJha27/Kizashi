...
test("checked-in grammar registry preserves the current evidence boundary", async () => {
  ...
  assert.deepEqual(registry.summary.N4, { rawPatterns: 185, canonicalConcepts: 67, complete: 3, partial: 56, missing: 8, unresolved: 88, levelDisagreements: 7 });
  ...
  assert.equal(registry.sources.find((source) => source.id === "irodori-sentence-patterns").references, 109);
