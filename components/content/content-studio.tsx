...
export function ContentStudio({ seed, seedHealth, questionHealth, questions, knownItemIds, sources = contentSources }: Readonly<{ seed: N5Module; seedHealth: ContentValidationResult; questionHealth: ContentValidationResult; questions: PracticeQuestion[]; knownItemIds: string[]; sources?: ContentSource[] }>) {
