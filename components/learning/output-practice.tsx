...
export function OutputPractice({ module }: Readonly<{ module: N5Module }>) {
  ...
  const reset = (index: number) => { setActivityIndex(index); setRevealed(false); setChoice(null); setWriting(""); setRating(null); };
