...
export function AozoraShelf() {
  ...
  const read = async () => {
    ...
    try {
      ...
      setEstimate(estimateAozoraDifficulty(payload.text, { vocabulary: module.vocabulary, kanji: module.kanji }));
    } catch (caught) {
