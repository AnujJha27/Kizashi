...
export function DailySession({ lessonId, items, allItems = items, module, targetLevel = "N5", world }: Readonly<{ lessonId: string; items: LessonContentItem[]; allItems?: LessonContentItem[]; module: N5Module; targetLevel?: TargetLevel; world?: { area: { title: string; japaneseTitle: string; description: string; visualAssets: { lesson: string }; focalPoint: { desktop: string; mobile: string } }; stage: { label: string } } }>) {
