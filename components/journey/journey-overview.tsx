  ...
  return <div className="journey-page mx-auto max-w-6xl">
    ...
    <div className="grid min-w-0 gap-6 lg:grid-cols-[minmax(0,1.25fr)_minmax(0,.75fr)]">
      ...
      <aside className="min-w-0 space-y-6">
        <section className="lesson-tracker surface-panel relative overflow-hidden p-6" style={{ backgroundImage: `linear-gradient(90deg, rgba(17, 18, 22, .9), rgba(17, 18, 22, .64)), url(${world.area.visualAssets.lessonTracker})`, backgroundSize: "cover", "--world-focal": world.area.focalPoint.desktop, "--world-focal-mobile": world.area.focalPoint.mobile } as CSSProperties}>
