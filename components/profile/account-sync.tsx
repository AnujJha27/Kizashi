...
export function AccountSync({ visible = true }: Readonly<{ visible?: boolean }>) {
  ...
  useEffect(() => {
    ...
    const events = ["michi-review-updated", "michi-mistakes-updated", "michi-notes-updated", "michi-question-stats-updated", "michi-study-stats-updated", "michi-pronunciation-updated", "michi-kanji-writing-updated", "michi-immersion-review-updated", "michi-saved-sentences-updated", "michi-study-later-updated", "michi-practice-session-updated", "michi-lesson-updated", "michi-diagnostic-updated", "michi-exam-attempt-updated", "michi-custom-entries-updated", "michi-book-notes-updated", "michi-content-flagged-updated"];
