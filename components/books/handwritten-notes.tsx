...
function notebookPdf(images: Uint8Array[]) {
  ...
  images.forEach((image, index) => {
    ...
    const content = `q\n842 0 0 589 0 0 cm\n/Im${index} Do\nQ`;
    object(pageId, `<< /Type /Page /Parent 2 0 R /MediaBox [0 0 842 589] /Resources << /XObject << /Im${index} ${imageId} 0 R >> >> /Contents ${contentId} 0 R >>`);
