...
export default async function LearnPage({ searchParams }: { searchParams: Promise<{ lesson?: string }> }) {
  ...
  return <LocalLesson requestedLessonId={requestedLessonId} fallbackLesson={lesson ?? null} fallbackItems={lesson ? getLessonItems(lesson) : []} fallbackContrasts={n5Module.grammarContrasts} />;
}
