...
export function getExternalSourceCoverage({ items = [], taeKimMappings = {}, wikibooksMappings = {}, irodoriResources = [], tadokuEntries = [], aozoraEnabled = false } = {}) {
  ...
  return {
    grammar: { taeKim: mappingCoverage(items, taeKimMappings), wikibooks: mappingCoverage(items, wikibooksMappings) },
