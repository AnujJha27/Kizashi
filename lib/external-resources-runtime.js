...
const registry = Object.freeze([
  ...
  { id: "irodori-ordering-food", sourceId: "irodori", name: "Irodori", title: "Order at a restaurant", description: "A Can-do follow-up for practicing a real restaurant interaction after Kizashi food and request study.", resourceType: "lesson", level: "初級1", url: "https://www.irodori.jpf.go.jp/en/resources.html", deliveryMode: "frame-or-link", targetItemIds: ["grammar-kudasai", "grammar-wo", "vocab-gohan"], targetSkills: ["real-world-practice"], tags: ["can-do", "food", "real-world-practice"], transformAllowed: false, metadata: { role: "real-world practice", rightsBehavior: "official-source-resource", shelf: false, course: "初級1", lesson: "Lesson 5", canDo: "レストランで注文する", resourceTypes: ["lesson", "script", "audio"], audioAvailable: true, audioDelivery: "provider-hosted", termsUrl: "https://www.irodori.jpf.go.jp/en/faq.html" } },
].map(freezeResource));
