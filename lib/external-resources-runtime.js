...
const registry = Object.freeze([
  ...
  { id: "japanese-with-shun", sourceId: "japanese-with-shun", name: "Japanese with Shun", title: "Easy Japanese video immersion", description: "Provider-hosted beginner-friendly vlogs and conversations for natural N5–N4 listening.", resourceType: "listening", level: "N5–N4", url: "https://www.youtube.com/@JapanesewithShun", deliveryMode: "frame-or-link", targetSkills: ["natural listening", "immersion"], tags: ["easy-japanese", "video", "immersion"], transformAllowed: false, metadata: { role: "easy-Japanese video immersion", rightsBehavior: "provider-hosted channel; link-only fallback", resourceTypes: ["video channel"] } },
  { id: "nihongo-con-teppei", sourceId: "nihongo-con-teppei", name: "Nihongo con Teppei", title: "Beginner podcast immersion", description: "Provider-hosted beginner podcast episodes for building a daily Japanese listening habit.", resourceType: "listening", level: "N5–N4", url: "https://teppei.nihongoconteppei.com/", deliveryMode: "frame-or-link", targetSkills: ["natural listening", "immersion"], tags: ["beginner-podcast", "audio", "immersion"], transformAllowed: false, metadata: { role: "beginner podcast immersion", rightsBehavior: "provider-hosted podcast; link-only fallback", resourceTypes: ["podcast", "audio"] } },
