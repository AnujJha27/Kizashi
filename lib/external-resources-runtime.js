...
const marugotoAdditionalCatalog = [
  { id: "marugoto-scripts", title: "Read Japanese scripts", sourceLevel: "A1", topic: "Starter · Japanese", activityType: "practical reading + pronunciation", url: "https://a1.marugotoweb.jp/en/can-do2.php", targetSkills: ["practical reading", "pronunciation"], communicativeFunction: "read Japanese scripts", jlptRelevance: "immersion practice · no JLPT claim", provenance: "Marugoto Plus official Can-do2 page; provider-hosted" },
  { id: "marugoto-menu", title: "Read a menu", sourceLevel: "A1", topic: "Starter · food", activityType: "practical reading", url: "https://a1.marugotoweb.jp/en/can-do14.php", targetSkills: ["practical reading", "information retrieval"], communicativeFunction: "read menu information", jlptRelevance: "immersion practice · no JLPT claim", provenance: "Marugoto Plus official Can-do14 page; provider-hosted" },
  { id: "marugoto-home", title: "Show someone around your home", sourceLevel: "A1", topic: "Starter · home", activityType: "conversation + reading", url: "https://a1.marugotoweb.jp/en/can-do21.php", targetSkills: ["real-world-practice", "speaking"], communicativeFunction: "describe a home", jlptRelevance: "immersion practice · no JLPT claim", provenance: "Marugoto Plus official Can-do21 page; provider-hosted" },
  { id: "marugoto-events", title: "Read posters and calendars for events", sourceLevel: "A1", topic: "Starter · days off", activityType: "practical reading", url: "https://a1.marugotoweb.jp/en/can-do30.php", targetSkills: ["practical reading", "information retrieval"], communicativeFunction: "find event time and place", jlptRelevance: "immersion practice · no JLPT claim", provenance: "Marugoto Plus official Can-do30 page; provider-hosted" },
];
...
const registry = Object.freeze([
  ...
  { id: "moshi-moshi-yusuke", sourceId: "moshi-moshi-yusuke", name: "もしもしゆうすけ", title: "Real-life Japanese", description: "Unscripted, provider-hosted videos about ordinary Japanese life, from stations and shops to walks and conversations.", resourceType: "listening", level: "N5–N4", url: "https://www.youtube.com/@moshimoshi.yusuke", deliveryMode: "frame-or-link", targetSkills: ["real-life Japanese", "natural listening", "immersion"], tags: ["immersion-provider", "real-life", "video", "immersion"], transformAllowed: false, metadata: { role: "real-life Japanese", immersionRole: "real-life", providerLevel: "Native / unscripted", kizashiRecommendedLevel: "N5–N4", nativeInput: true, aliases: ["もしもしゆうすけ", "Moshi Moshi Yusuke"], journeyContexts: ["neighborhood", "station", "shopping-street", "market"], contentTypes: ["real life", "monologue", "conversation", "walk / town", "practical interaction"], rightsBehavior: "provider-hosted YouTube video; official channel fallback", resourceTypes: ["video catalog", "channel"], videoCatalogFeed: "https://www.youtube.com/feeds/videos.xml?channel_id=UCcCeJ3pQYFgvfVuMxVRWhoA", videoCatalogChannelId: "UCcCeJ3pQYFgvfVuMxVRWhoA" } },
  { id: "natural-japanese", sourceId: "natural-japanese", name: "Natural Japanese", title: "Comprehensible input", description: "Supported Japanese through stories, visuals, dialogues, and everyday scenarios from the provider-hosted public catalog.", resourceType: "listening", level: "N5–N4", url: "https://www.youtube.com/@nijapanese", deliveryMode: "frame-or-link", targetSkills: ["comprehensible input", "natural listening", "immersion"], tags: ["immersion-provider", "comprehensible-input", "video", "immersion"], transformAllowed: false, metadata: { role: "comprehensible input", immersionRole: "comprehensible-input", providerLevel: "Beginner–Advanced", kizashiRecommendedLevel: "N5–N4", nativeInput: false, aliases: ["Comprehensible Japanese", "CIJ", "NIJ"], journeyContexts: ["neighborhood", "station", "shopping-street", "garden"], contentTypes: ["stories", "dialogue", "visual context", "everyday scenarios"], rightsBehavior: "provider-hosted YouTube video; official channel fallback", resourceTypes: ["video catalog", "channel"], videoCatalogFeed: "https://www.youtube.com/feeds/videos.xml?channel_id=UCXo8kuCtqLjL1EH6m4FJJNA", videoCatalogChannelId: "UCXo8kuCtqLjL1EH6m4FJJNA" } },
  { id: "cure-dolly", sourceId: "cure-dolly", name: "Organic Japanese with Cure Dolly", title: "How Japanese works", description: "An archived structural reference for grammar intuition and Japanese sentence structure; it is not native-listening or a pronunciation model.", resourceType: "grammar-reference", level: "N5–N4", url: "https://www.youtube.com/@organicjapanesewithcuredol49", deliveryMode: "frame-or-link", targetSkills: ["structural explanation", "grammar intuition"], tags: ["immersion-provider", "guided-understanding", "video", "grammar-reference"], transformAllowed: false, metadata: { role: "structural grammar explanation", immersionRole: "guided-understanding", providerLevel: "Archived reference", kizashiRecommendedLevel: "N5–N4", nativeInput: false, aliases: ["Organic Japanese", "Cure Dolly"], journeyContexts: ["assessment", "neighborhood"], contentTypes: ["structural explanation", "grammar intuition", "sentence structure"], rightsBehavior: "provider-hosted YouTube video; archived reference", resourceTypes: ["video catalog", "channel"], videoCatalog: [{ id: "ElDZE_BmFVc", title: "Japanese conjugation: deconstruct and assimilate", level: "N5–N4", publishedAt: "2020-05-16", url: "https://www.youtube.com/watch?v=ElDZE_BmFVc", frameUrl: "https://www.youtube-nocookie.com/embed/ElDZE_BmFVc?rel=0", posterUrl: "https://i.ytimg.com/vi/ElDZE_BmFVc/hqdefault.jpg", targetItemIds: ["grammar-masu", "grammar-dictionary-form", "grammar-te-form", "grammar-ta-form"], mappedTopics: ["verb forms", "stem system", "て-form / た-form"] }], videoCatalogFeed: "https://www.youtube.com/feeds/videos.xml?channel_id=UCkdmU8hGK4Fg3LghTVtKltQ", videoCatalogChannelId: "UCkdmU8hGK4Fg3LghTVtKltQ" } },
  { id: "tae-kim-grammar", sourceId: "tae-kim", name: "Tae Kim's Guide", title: "Alternative grammar explanation", description: "A structural, Japanese-first alternative explanation for mapped grammar points.", resourceType: "grammar-reference", url: "https://guidetojapanese.org/learn/grammar", deliveryMode: "reference", tags: ["alternative-explanation", "guided-understanding"], license: "CC BY-NC-SA 3.0", attribution: "Tae Kim's Guide to Japanese", transformAllowed: false, metadata: { role: "alternative grammar intuition", immersionRole: "guided-understanding", providerLevel: "Reference", kizashiRecommendedLevel: "N5–N4", nativeInput: false, contentTypes: ["structural explanation"], rightsBehavior: "deep-link; do-not-relabel-source-prose" } },
  ...
  { id: "marugoto-plus", sourceId: "marugoto", name: "Marugoto Plus", title: "Can-do conversation and culture", description: "Provider-hosted conversation, listening, pronunciation, and culture activities that reinforce practical Japanese.", resourceType: "lesson", level: "A1–A2", url: "https://a1.marugotoweb.jp/en/", deliveryMode: "frame-or-link", targetItemIds: ["vocab-watashi", "vocab-gakusei", "vocab-gohan", "vocab-taberu", "vocab-doko", "vocab-ikura", "grammar-desu", "grammar-wa", "grammar-masu", "grammar-ni", "grammar-kudasai"], targetSkills: ["real-world-practice", "natural listening", "shadowing", "pronunciation"], tags: ["immersion-provider", "practical-reading", "can-do"], transformAllowed: false, metadata: { role: "can-do conversation and pronunciation reinforcement", rightsBehavior: "provider-hosted; source terms control", context: "Starter · conversations and everyday situations", frameUrl: "https://a1.marugotoweb.jp/en/", resourceTypes: ["conversation", "listening", "pronunciation", "culture"], catalog: [{ id: "marugoto-greetings", title: "Greet and introduce yourself", sourceLevel: "A1", topic: "Starter · self-introduction", activityType: "conversation", url: "https://a1.marugotoweb.jp/en/can-do1.php", audioAvailable: true, targetItemIds: ["vocab-watashi", "vocab-gakusei", "grammar-desu", "grammar-wa"], targetSkills: ["real-world-practice", "natural listening", "shadowing"], communicativeFunction: "self-introduction", jlptRelevance: "N5 bridge · reviewed mapping", provenance: "Marugoto Plus official activity index; provider-hosted" }, { id: "marugoto-ordering", title: "Order food and make a request", sourceLevel: "A1", topic: "Starter · food and service", activityType: "conversation + listening", url: "https://a1.marugotoweb.jp/en/can-do15.php", audioAvailable: true, targetItemIds: ["vocab-gohan", "vocab-taberu", "grammar-kudasai", "grammar-wo"], targetSkills: ["real-world-practice", "pronunciation"], communicativeFunction: "order and request politely", jlptRelevance: "N5 bridge · reviewed mapping", provenance: "Marugoto Plus official activity index; provider-hosted" }, { id: "marugoto-directions", title: "Ask how to get to a place", sourceLevel: "A1", topic: "Starter · places and directions", activityType: "Can-do practice", url: "https://a1.marugotoweb.jp/en/can-do35.php", audioAvailable: true, targetItemIds: ["vocab-doko", "grammar-ni"], targetSkills: ["real-world-practice", "shadowing"], communicativeFunction: "ask how to get somewhere", jlptRelevance: "N5 bridge · reviewed mapping", provenance: "Marugoto Plus official activity index; provider-hosted" }, ...marugotoAdditionalCatalog] } },
...
export function externalResourceToSourceLink(resource) {
  ...
  return {
    ...
    frameUrl: stringValue(metadata.frameUrl),
    ...
    immersionRole: stringValue(metadata.immersionRole),
    providerLevel: stringValue(metadata.providerLevel),
    kizashiRecommendedLevel: stringValue(metadata.kizashiRecommendedLevel),
    aliases: stringArrayValue(metadata.aliases),
    nativeInput: booleanValue(metadata.nativeInput),
    journeyContexts: stringArrayValue(metadata.journeyContexts),
    contentTypes: stringArrayValue(metadata.contentTypes),
