...
function mediaDeliveryFor(resource) {
  ...
  // ponytail: Marugoto sends frame-blocking headers; direct source is the reliable learner path.
  if (resource.id === "marugoto-plus") return "link-only";
