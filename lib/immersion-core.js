...
const erinLessonSources = [
  { id: "erin-01", name: "Erin's Challenge", title: "First-meeting greetings · classroom", level: "N5", context: "greetings", targetSkills: ["self-introduction"], targetItemIds: ["vocab-watashi", "grammar-desu", "grammar-wa"], description: "Open the Japan Foundation lesson page; its scripts and media stay on the original site.", url: "https://www.erin.jpf.go.jp/en/lesson/01/basic/" },
  { id: "erin-02", name: "Erin's Challenge", title: "Making requests · school", level: "N5", context: "requests", targetSkills: ["polite request"], targetItemIds: ["grammar-kudasai", "grammar-wo"], description: "Open the Japan Foundation lesson page; its scripts and media stay on the original site.", url: "https://www.erin.jpf.go.jp/en/lesson/02/basic/" },
  { id: "erin-03", name: "Erin's Challenge", title: "Indicating things · home", level: "N5", context: "demonstratives", targetSkills: ["object reference"], targetItemIds: ["vocab-kore", "vocab-sore", "grammar-kore"], description: "Open the Japan Foundation lesson page; its scripts and media stay on the original site.", url: "https://www.erin.jpf.go.jp/en/lesson/03/basic/" },
  { id: "erin-04", name: "Erin's Challenge", title: "Asking locations · convenience store", level: "N5", context: "locations", targetSkills: ["location question"], targetItemIds: ["vocab-doko", "grammar-doko", "grammar-ni", "grammar-de"], description: "Open the Japan Foundation lesson page; its scripts and media stay on the original site.", url: "https://www.erin.jpf.go.jp/en/lesson/04/basic/" },
  { id: "erin-06", name: "Erin's Challenge", title: "Asking prices · bus", level: "N5", context: "prices", targetSkills: ["price question"], targetItemIds: ["vocab-ikura", "vocab-en", "grammar-ka"], description: "Open the Japan Foundation lesson page; its scripts and media stay on the original site.", url: "https://www.erin.jpf.go.jp/en/lesson/06/basic/" },
  { id: "erin-08", name: "Erin's Challenge", title: "Ordering · fast food", level: "N5", context: "ordering food", targetSkills: ["service interaction"], targetItemIds: ["vocab-gohan", "grammar-kudasai", "grammar-wo"], description: "Open the Japan Foundation lesson page; its scripts and media stay on the original site.", url: "https://www.erin.jpf.go.jp/en/lesson/08/basic/" },
];
