...
const erinLessonSources = [
  ...
  { ...erinAnnotation, id: "erin-06", name: "Erin's Challenge", title: "Asking prices · bus", level: "N5", context: "prices", targetSkills: ["price question"], targetItemIds: ["vocab-ikura", "vocab-en", "grammar-ka"], description: "Open the Japan Foundation lesson page; its scripts and media stay on the original site.", url: "https://www.erin.jpf.go.jp/en/lesson/06/basic/" },
