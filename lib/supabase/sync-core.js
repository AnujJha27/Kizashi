...
const objectCollections = new Set([
  ...
  "bookNotes",
  "contentFlags",
  "kanjiWritingProgress",
  "immersionVideoReviews",
]);
const valueCollections = new Set(["studyStats", "profilePreferences", "pronunciationProgress", "diagnosticResult", "currentLessonState", "continueState"]);
