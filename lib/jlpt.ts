...
export const contentSources: ContentSource[] = [
  ...
  { id: "kanjivg", name: "KanjiVG", type: "official", url: "https://github.com/KanjiVG/kanjivg", license: "CC BY-SA 3.0", notes: "Ordered stroke paths for the canonical N5/N4 kanji union." },
  ...
  { id: "openjlpt-vocab-n5", name: "OpenJLPT vocab N5", type: "curriculum", url: "https://raw.githubusercontent.com/evanclan/OpenJLPT/main/data/json/vocab/n5.json", license: "CC BY-SA 4.0", notes: "Staged source input; classification remains review-visible." },
  { id: "openjlpt-kanji-n5", name: "OpenJLPT kanji N5", type: "curriculum", url: "https://raw.githubusercontent.com/evanclan/OpenJLPT/main/data/json/kanji/n5.json", license: "CC BY-SA 4.0", notes: "Staged source input; classification remains review-visible." },
  { id: "openjlpt-grammar-n5", name: "OpenJLPT grammar N5", type: "curriculum", url: "https://raw.githubusercontent.com/evanclan/OpenJLPT/main/data/json/grammar/n5.json", license: "CC BY-SA 4.0", notes: "Staged source input; classification remains review-visible." },
  { id: "openjlpt-vocab-n4", name: "OpenJLPT vocab N4", type: "curriculum", url: "https://raw.githubusercontent.com/evanclan/OpenJLPT/main/data/json/vocab/n4.json", license: "CC BY-SA 4.0", notes: "Staged source input; classification remains review-visible." },
  { id: "openjlpt-kanji-n4", name: "OpenJLPT kanji N4", type: "curriculum", url: "https://raw.githubusercontent.com/evanclan/OpenJLPT/main/data/json/kanji/n4.json", license: "CC BY-SA 4.0", notes: "Staged source input; classification remains review-visible." },
  { id: "openjlpt-grammar-n4", name: "OpenJLPT grammar N4", type: "curriculum", url: "https://raw.githubusercontent.com/evanclan/OpenJLPT/main/data/json/grammar/n4.json", license: "CC BY-SA 4.0", notes: "Staged source input; classification remains review-visible." },
  ...
  { id: "irodori-wordlist", name: "Japan Foundation Irodori vocabulary", type: "curriculum", url: "https://www.irodori.jpf.go.jp/assets/data/wordlist_all.xlsx", license: "Japan Foundation Irodori terms; personal educational use", notes: "Official vocabulary reference; review terms before publishing derived content." },
  { id: "irodori-sentence-patterns", name: "Japan Foundation Irodori sentence patterns", type: "curriculum", url: "https://www.irodori.jpf.go.jp/assets/data/sentence_patterns_list.xlsx", license: "Japan Foundation official material; verify current terms before publishing.", notes: "Source pattern evidence for mapped Kizashi grammar; preserve the original course and lesson context." },
  { id: "irodori-kanji", name: "Japan Foundation Irodori kanji", type: "curriculum", url: "https://www.irodori.jpf.go.jp/assets/data/kanji_list.xlsx", license: "Japan Foundation Irodori terms; personal educational use", notes: "Official kanji progression reference; dictionary facts require review before publishing." },
  ...
  { id: "marugoto-starter-vocab", name: "Marugoto Starter vocabulary index", type: "curriculum", url: "https://marugoto.jpf.go.jp/en/download/", license: "Japan Foundation official material; verify current terms before publishing.", notes: "Extracted vocabulary candidates are staging-only and require review." },
  { id: "marugoto-elementary1-vocab", name: "Marugoto Elementary 1 vocabulary index", type: "curriculum", url: "https://marugoto.jpf.go.jp/en/download/", license: "Japan Foundation official material; verify current terms before publishing.", notes: "Extracted vocabulary candidates are staging-only and require review." },
  { id: "marugoto-elementary2-vocab", name: "Marugoto Elementary 2 vocabulary index", type: "curriculum", url: "https://marugoto.jpf.go.jp/en/download/", license: "Japan Foundation official material; verify current terms before publishing.", notes: "Extracted vocabulary candidates are staging-only and require review." },
  ...
  { id: "tatoeba-jpn-indices", name: "Tatoeba Japanese indices", type: "examples", url: "https://tatoeba.org/en/downloads", license: "Tatoeba data license", notes: "Japanese-English sentence pair candidates; retain per-sentence attribution before publishing." },
  { id: "tatoeba-sentences", name: "Tatoeba sentences", type: "examples", url: "https://tatoeba.org/en/downloads", license: "Tatoeba data license", notes: "English sentence text used to resolve Japanese index pairs; retain per-sentence attribution before publishing." },
  { id: "michi-curated-n5-seed", name: "Kizashi curated N5 seed", type: "curriculum", notes: "Original authored curriculum and examples." },
  { id: "michi-authored-n4-grammar", name: "Kizashi authored N4 grammar expansion", type: "curriculum", notes: "Original N4 bridge grammar authored for Kizashi; not an external authority claim." },
