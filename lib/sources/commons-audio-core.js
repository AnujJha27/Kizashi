...
function hasJapaneseEvidence(metadata) {
  const evidence = metadataValue(metadata, "Categories", "Category", "Language", "ContentLanguage", "Collection", "Description");
  return /japanese|日本語|lingua libre|\bjpn\b|\bja(?:-jp)?\b/iu.test(evidence);
}
