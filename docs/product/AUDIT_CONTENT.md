...
- [~] The current registry reports N5 224 raw patterns / 46 canonical concepts (17 complete, 23 partial, 6 missing, 100 unresolved) and N4 188 raw patterns / 70 canonical concepts (9 complete, 55 partial, 6 missing, 79 unresolved). Sixty-five N4 concepts are authored in the dedicated expansion lessons, five additional N4 bridge concepts remain in the life module, and six N5 concepts are authored from exact OpenJLPT evidence; fourteen explicit contrast clusters now connect direction, benefit perspective, inference/appearance, conditionals, potential ability, passive/potential, causative forms, change/habit/decision forms, modality/inference forms, quotation/thought forms, nominalization/capability forms, contrast/conjunction forms, time/aspect forms, and ease/difficulty forms. The registry still keeps source-level disagreements and unresolved rows visible. It now includes 123 reviewed Irodori mapping references plus 21 curated OpenJLPT alias references and marks mapped source records resolved; level disagreements remain visible (N5 4, N4 9, including the Starter-level basic giving/receiving evidence, Elementary 1 quotation/thought and nominalization mappings, and the two Elementary 1 てみる／すぎる mappings). This is an honest coverage baseline, not a claim of grammar completeness.
