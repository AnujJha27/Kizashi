...
- [~] The current registry reports N5 224 raw patterns / 46 canonical concepts (23 complete, 18 partial, 5 missing, 89 unresolved) and N4 188 raw patterns / 70 canonical concepts (12 complete, 53 partial, 5 missing, 75 unresolved). Sixty-five N4 concepts are authored in the dedicated expansion lessons, five additional N4 bridge concepts remain in the life module, and six N5 concepts are authored from exact OpenJLPT evidence; fourteen explicit contrast clusters now connect direction, benefit perspective, inference/appearance, conditionals, potential ability, passive/potential, causative forms, change/habit/decision forms, modality/inference forms, quotation/thought forms, nominalization/capability forms, contrast/conjunction forms, time/aspect forms, and ease/difficulty forms. The registry still keeps source-level disagreements and unresolved rows visible. It now includes 142 reviewed Irodori mapping references plus 21 curated OpenJLPT alias references and marks mapped source records resolved; level disagreements remain visible (N5 7, N4 11, including the Elementary 1 `V-る前に` evidence, the Pre-Intermediate evidence for `なくてもいい`, and the Starter-level basic giving/receiving evidence alongside the Elementary 1 quotation/thought and nominalization mappings and the two Elementary 1 てみる／すぎる mappings). This is an honest coverage baseline, not a claim of grammar completeness.
