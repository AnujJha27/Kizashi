...
| `jfs-reading` | [JFS Reading Activities](https://www.kyozai.jpf.go.jp/kyozai/material/jfs/home/ja/render.do) | Practical A1–A2 reading tasks: menus, notices, schedules, prices, and messages | Provider-hosted source reference in Immersion; no copied assessment content. |
| `kc-yom-yom` | [KC Yom Yom](https://www.jpf.go.jp/j/kansai/clip/yomyom/index.html) | Extensive reading with optional audio at A1–A2/B1 source levels | Provider-hosted, unchanged reading entry; preserve individual asset attribution and terms. |
| `hirogaru` | [Hirogaru](https://www.hirogaru-nihongo.jpf.go.jp/en/) | Interest-driven Japanese reading, video, and culture exposure | Provider-hosted Immersion entry; no mirrored articles, video, or media. |
| `ojad` | [OJAD](https://www.gavo.t.u-tokyo.ac.jp/ojad/eng/pages/home) | Optional pronunciation, pitch-accent, conjugation, and prosody reference | Provider-hosted reference link; no OJAD data or audio mirror and no JLPT classification. |
...
| [Japanese with Shun](https://www.youtube.com/@JapanesewithShun) | Easy N5–N4 video immersion and natural listening | The registry reads a bounded catalog from YouTube's official public channel feed; the learner selects a provider-hosted player URL, with the official channel as fallback. Kizashi stores no video. |
| [Nihongo con Teppei](https://nihongoconteppei.com/) | Beginner podcast immersion and daily listening habit | The registry reads a bounded catalog from the provider's official RSS feed; Immersion plays the supplied remote audio when available and links to the original episode as fallback. Kizashi stores only source metadata and opened progress. |
...
| [Free Tadoku Books](https://tadoku.org/japanese/en/free-books-en/) | Beginner graded extensive reading in `読む · 多読`, with four featured entries plus access to the complete catalog. | Original provider-hosted pages/audio through `ExternalSourceViewer` and `RemoteAudioProvider`; entries are marked non-transformable and only local progress metadata is stored. | If framing is blocked, the original Tadoku page or complete catalog opens directly; no copied pages, translations, questions, or illustrations are created. |
| [Marugoto Plus](https://marugotoweb.jp/en/) | Can-do conversation, listening, pronunciation, and culture reinforcement in Learn follow-ups for mapped starter targets and Immersion `寄り道`. | The shared registry entry and lesson follow-up open the provider-hosted site in the existing frame-or-link viewer; no Marugoto Plus media or activities are copied. | The original provider link remains available if framing is blocked. |
| [JFS Reading Activities](https://www.kyozai.jpf.go.jp/kyozai/material/jfs/home/ja/render.do) | Practical reading for finding prices, times, menu items, notices, messages, and other everyday information. | Shared registry entry opens the provider-hosted A1–A2 activity catalog; source material remains external and non-transformable. | The provider link remains available if framing is blocked or unavailable. |
| [KC Yom Yom](https://www.jpf.go.jp/j/kansai/clip/yomyom/index.html) | Extensive reading of short easy Japanese books with optional provider-hosted audio. | Shared registry entry opens the provider-hosted catalog; no books, audio, or generated questions are mirrored. | The original catalog link remains available if framing or audio is unavailable. |
| [Hirogaru](https://www.hirogaru-nihongo.jpf.go.jp/en/) | Interest-driven reading, video, and culture exposure for sustained immersion beyond exam preparation. | Shared registry entry opens provider-hosted topic material through the existing frame-or-link viewer; exposure is tracked only by the existing opened marker. | The original site link remains available if framing is blocked. |
| [OJAD](https://www.gavo.t.u-tokyo.ac.jp/ojad/eng/pages/home) | Optional pronunciation, pitch-accent, and prosody reference from pronunciation details and source detours. | Shared registry entry opens OJAD's provider-hosted tools; no OJAD data/audio is copied and it does not affect JLPT readiness. | The source link remains available if framing is blocked; normal Kizashi audio remains usable. |
