...
- [~] Per-video comprehension scoring and reviewed grammar-to-video mappings remain open until reliable provider metadata or a reviewed mapping table exists.
