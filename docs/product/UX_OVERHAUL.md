...
- [x] **Guided output lane** — `components/learning/output-practice.tsx`; Real life immersion includes speaking, writing, pragmatic interpretation, and natural-phrase self-checks without changing JLPT readiness.
