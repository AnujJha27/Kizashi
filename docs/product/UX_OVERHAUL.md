...
- [~] **Vocabulary context contract** — `lib/content-completeness-core.js` now audits example depth, collocations, related words, persisted audio, contextual/paraphrase links, and N4 usage assessments; current persisted vocabulary coverage remains partial and generated fallback drills are excluded.
