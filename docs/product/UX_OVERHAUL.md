...
- [~] **Grammar prose consistency** — `lib/content-completeness-core.js` audits duplicate examples, translation collisions, and empty example fields across the authored grammar package; current findings remain review-only pending content rewrite.
