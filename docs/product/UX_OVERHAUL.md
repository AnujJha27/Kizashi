...
- [x] 2026-09-05 quality checkpoint — the shared authored-bank report now flags reading distractors whose normalized text occurs in the passage, and Content Studio renders a bounded record/question-family/distractor review list plus N5/N4 source-length signals. The current bank has 37 affected question sets and 59 copied distractor choices, with 39/51 average source characters by level; this is structural evidence and keeps linguistic plausibility/native review open.
