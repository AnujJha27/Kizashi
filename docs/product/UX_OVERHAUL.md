...
- [x] **Mobile/accessibility/performance** — responsive navigation, deferred module loading, bounded Practice questions, a dedicated Studio route fallback, idle-scheduled Studio draft work, memoized 8k-item Studio scans, bounded question review, and scroll-safe overlays are in code; the final cross-surface audit remains a follow-up.
