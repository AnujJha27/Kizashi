...
- [x] **Conjugation focus** — the existing PracticePlayer exposes reviewed vocabulary polite-form production prompts through `/practice?mode=conjugation`; it stays inside Focus while reading/listening drills remain in Immersion.
...
- [~] **Visual refinement/card density** — Immersion navigation plus reading/listening, Irodori activities, source detours, Tadoku, Aozora, and the Studio source/review queues use compact/editorial layouts; the final U65/U66/U70 accessibility pass remains.
