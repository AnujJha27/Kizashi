...
- [x] 2026-09-05 map refinement — the route map uses a separate tall generated WebP composition rather than reusing the horizontal area hero, with the map asset cached and documented as its own visual role.
