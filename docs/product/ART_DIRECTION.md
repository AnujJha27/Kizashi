...
- [x] Immersion provider cards keep visual role labels and comprehension review controls subordinate to the provider-hosted media; feed-health fallback states use the same quiet status language and do not turn the source shelf into a dashboard.
