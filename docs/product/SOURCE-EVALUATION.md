...
| [Marugoto Plus](https://marugotoweb.jp/en/) | The Japan Foundation presents MARUGOTO+ as a support website for its coursebook and provides provider-hosted language/culture activities; activity-specific site terms remain authoritative. | Register the provider site as an Immersion activity entry. Keep conversation, listening, pronunciation, and culture material on the source; do not copy or transform its activities. |
| [JFS Reading Activities](https://www.kyozai.jpf.go.jp/kyozai/material/jfs/home/ja/render.do) | The Japan Foundation's Minna no Kyozai site publishes JFS A1/A2 practical reading activities for everyday information retrieval. | Use a provider-hosted practical-reading launcher. Preserve the source URL and keep source reading material outside Kizashi assessment generation. |
| [KC Yom Yom](https://www.jpf.go.jp/j/kansai/clip/yomyom/index.html) | The Japan Foundation Kansai Center describes KC Yom Yom as A1–A2/B1 extensive-reading books and identifies CC BY-NC 2.1 Japan handling for the collection; individual asset terms still control. | Keep the books and optional MP3s provider-hosted, preserve attribution, and expose only a non-transformable reading entry. Do not mirror assets or generate quizzes from them. |
| [Hirogaru site policy](https://www.hirogaru-nihongo.jpf.go.jp/en/site_policy/index.html) | Hirogaru is a Japan Foundation provider-hosted learning site whose policy governs its articles, links, translations, and media. | Use a provider-hosted interest-immersion launcher only. Do not copy articles, images, video, or translations into Kizashi. |
| [OJAD](https://www.gavo.t.u-tokyo.ac.jp/ojad/eng/pages/home) and [OJAD usage](https://www.gavo.t.u-tokyo.ac.jp/ojad/eng/pages/usage) | The University of Tokyo OJAD provides word, suffix, text, and prosody tools, including provider-controlled speech samples and pitch displays. | Use an optional provider-hosted pronunciation reference. Do not bulk mirror OJAD data or audio and do not make it a required N5/N4 or JLPT classification source. |
