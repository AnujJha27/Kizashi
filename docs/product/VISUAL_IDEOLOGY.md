...
- [~] Practical reading material uses Kizashi-owned HTML visual aids for authored notices, menus, schedules, posters, and directions while preserving Japanese as accessible text; richer format variety and screenshot review remain open.
