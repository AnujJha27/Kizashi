...
- [~] Practical reading visuals now use Kizashi-owned HTML layouts driven by explicit notice/menu/timetable/poster/directions metadata in the 27 information-retrieval assets; Japanese remains accessible text rather than generated pixels. Format variety and native review remain open.
