...
- [~] Vocabulary context audit — `lib/content-completeness-core.js` now reports examples, collocations, related words, persisted audio, contextual/paraphrase assessment links, and N4 usage coverage; across 169 current records, 72 have two examples, all have collocations/related words, 16 have usage assessments, and none yet meet the complete persisted contract because generated fallback questions are not counted.
