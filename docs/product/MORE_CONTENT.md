...
- [~] Practical reading visuals now pair four generated no-text raster scene assets with Kizashi-owned HTML layouts driven by explicit notice/menu/timetable/poster/directions metadata in the 27 information-retrieval assets; `lib/learning-visual-assets.ts` keeps their generated-raster provenance centralized, and Japanese remains accessible HTML rather than generated pixels. Format variety and native review remain open.
