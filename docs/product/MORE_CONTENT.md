...
- [~] Original Kizashi grammar prose now has a consistency audit in `lib/content-completeness-core.js`; it reports 12 duplicate-example items, 14 duplicate rows, and 5 cross-item translation collisions across 116 grammar records, with no empty examples. The source rows remain review-visible until rewritten.
