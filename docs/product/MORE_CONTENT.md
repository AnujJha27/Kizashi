...
- [~] Content Studio now runs a deterministic authored-bank quality audit: reading is 115/115 unique normalized passage templates with 143 questions across 11 question families, 0 near-duplicate clusters, 0 structural answer-choice failures, and 104 exact passage-answer echoes surfaced for review; its report also exposes linked vocabulary/grammar/kanji load ranges and blank/duplicate/under-three-distractor signals. Listening is 160/160 unique normalized templates across 20 context tags with 0 near-duplicate clusters, with question-family, context, source-type, turn-profile, speaker-pattern, and transcript-answer-echo counts visible; the current bank is 80 three-turn `A-B-A` and 80 four-turn `A-B-A-B`, with 92/160 answer echoes flagged for review. The reading generator now includes repeated reason, reference, simple-inference, and appropriate-action prompts, while the listening generator varies prompts/scripts and removes prior exact and cross-level duplicates; all 160 current scenarios remain browser-TTS, so naturalness still needs human-speaker review.
