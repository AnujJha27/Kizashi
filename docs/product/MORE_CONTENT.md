...
- [~] Kanji entries now include a native Watch/Trace/Write trainer shell and lazy Jisho/Tanoshii references through the existing source viewer; KanjiVG path import, Practice Focus routing, and separate writing-state persistence remain pending until the local stroke dataset is populated.
