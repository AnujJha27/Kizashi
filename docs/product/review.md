...
Still open from this report: field-level edit-in-place, expanded N5/N4 reservoir promotion and coverage counts, automatic exclusion of flagged questions from queues, and the owner setting for hiding provisional controls. Rejected records remain excluded by the learner release gate; provisional records remain learner-visible and visibly labeled.
